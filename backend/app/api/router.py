...
from app.api.endpoints import auth, goals, tasks, finance, habits, calendar, ai_chat, finance_subscriptions
...
api_router.include_router(finance_subscriptions.router, prefix="/finance/subscriptions", tags=["finance-subscriptions"])
