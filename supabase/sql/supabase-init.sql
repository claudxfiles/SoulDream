...
VALUES 
  ('Free', 'Plan básico con funcionalidades limitadas', 0.00, 'USD', 'month', 
   '["Gestión básica de tareas",
     ...
     "5 interacciones con IA al día"]'::jsonb, 
   true),
  
  ('Pro', 'Plan profesional con funcionalidades avanzadas', 9.99, 'USD', 'month', 
   '["Gestión básica de tareas",
     "Seguimiento de hábitos",
     "Registro financiero avanzado",
     "50 interacciones con IA al día",
     "Análisis financiero avanzado",
     "Integración con Google Calendar"]'::jsonb, 
   true),
  ...
  ('Premium', 'Plan completo con todas las funcionalidades', 19.99, 'USD', 'month', 
   '["Gestión básica de tareas",
     ...
     "Soporte prioritario",
     "Generación de planes avanzados con IA"]'::jsonb, 
   true);
